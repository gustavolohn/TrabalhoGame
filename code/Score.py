...
from code.Const import COLOR_YELLOW, SCORE_POS, MENU_OPTION, COLOR_WHITE, COLOR_BLACK
...
class Score:
    ...
    def show(self):
        ...
        self.score_text(30, 'TOP 10 SCORE', COLOR_BLACK, SCORE_POS['Title'])
        self.score_text(25, 'Name    Score    Date       ', COLOR_BLACK, SCORE_POS['Label'])
        db_proxy = DBProxy('DBScore')
        ...
        for player_score in list_score:
            ...
            self.score_text(20, f'{name}     {score :05d}      {date}', COLOR_BLACK, SCORE_POS[list_score.index(player_score)])
